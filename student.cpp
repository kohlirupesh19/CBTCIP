...
{
cout<<"\nPress 1 to Enter "<<endl<<endl;
cout<<"Press 2 to Show "<<endl<<endl;
cout<<"Press 3 to Search "<<endl<<endl;
cout<<"Press 4 to Update "<<endl<<endl;
cout<<"Press 5 to Delete "<<endl<<endl;
